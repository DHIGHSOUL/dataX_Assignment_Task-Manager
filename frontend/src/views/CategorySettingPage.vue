  ...
  .category-setting-body
    .category-list
      ...
      .category-list-container
        .category-item-dummy(@click="showCreateModal = true")
          .category-name-dummy +
        .category-card-item(v-for="category in categories" :key="category.id" :style="getCategoryStyle(category.color)" @click="openChangeModal(category.id)")
          .category-card-item-content {{ category.name }}
